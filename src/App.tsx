    ...
    <div className="w-full min-h-screen bg-gradient-to-br from-orange-50 to-amber-50 text-gray-800">
      ...
      >
        ...
        <div className="relative z-10 text-center">
          <h1 className="text-8xl font-bold mb-6 animate-fade-in text-white">Pro Boxing Camp</h1>
          <p className="text-3xl mb-10 text-white">January 3-7, 2024</p>
          <button 
            onClick={scrollToPricing}
            className="bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white px-12 py-4 rounded-lg 
            transform hover:scale-105 transition duration-300 text-2xl font-semibold"
          >
            Join Now
          </button>
        </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-5xl font-bold text-center mb-12">Daily Schedule</h2>
      ...
      >
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <h2 className="text-6xl font-bold text-center mb-16 text-white">Training Overview</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {trainingHours.map((item, index) => (
              <div 
                key={index}
                className="relative group p-8 rounded-2xl bg-white bg-opacity-10 backdrop-blur-lg shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden"
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="text-center">
                    <h3 className="text-3xl font-semibold mb-2 text-white">{item.title}</h3>
                    <div className="flex items-center justify-center space-x-2">
                      <span className="text-5xl font-bold text-orange-500">{item.hours}</span>
                      <Timer className="w-8 h-8 text-orange-500 animate-pulse" />
                    </div>
                    <p className="text-white text-xl mt-2">Hours</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section id="pricing" ref={pricingRef} className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-5xl font-bold text-center mb-12">Choose Your Plan</h2>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-8">
            <a
              href="tel:+1234567890"
              className="flex items-center justify-center space-x-3 bg-white px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition duration-300 w-full md:w-auto"
            >
              <Phone className="w-8 h-8 text-orange-500" />
              <span className="text-2xl font-semibold text-gray-800">+1 (234) 567-890</span>
            </a>
            <a
              href="https://t.me/proboxingcamp"
              className="flex items-center justify-center space-x-3 bg-gradient-to-r from-orange-500 to-amber-500 px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition duration-300 w-full md:w-auto"
            >
              <Send className="w-8 h-8 text-white" />
              <span className="text-2xl font-semibold text-white">Telegram</span>
            </a>
          </div>
        </div>
      </section>
